...
<section
	...
	class="htm25-stats htm25-style--<?php echo esc_attr( $style ); ?> htm25-stats--<?php echo esc_attr( $layout ); ?>"
...
>
	...
	<div class="htm25-stats__inner">
		...
		<div class="htm25-stats__header">
			...
			<?php endif; ?>
			<?php if ( $headline ) : ?>
			<<?php echo esc_html( $headline_tag ); ?> class="htm25-stats__headline"><?php echo wp_kses_post( $headline ); ?></<?php echo esc_html( $headline_tag ); ?>>
			<?php endif; ?>
			<?php if ( $description ) : ?>
		...
		<?php if ( $items ) : ?>
		<div class="htm25-stats__grid htm25-stats__grid--cols-<?php echo esc_attr( $cols ); ?>" role="list">
