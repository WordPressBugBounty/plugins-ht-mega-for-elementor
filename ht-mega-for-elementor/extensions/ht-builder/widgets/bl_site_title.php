...
class Bl_Site_Title_ELement extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Site Title', 'ht-mega-for-elementor' );
    }
    ...
    public function get_keywords() {
        return ['site title', 'default title','blog title', 'htmega', 'ht mega', 'addons','widget'];
    }
    ...
    protected function render( $instance = [] ) {
        ...
        if( Elementor::instance()->editor->is_edit_mode() ){
            echo sprintf( '<%1$s class="htsite-title">' . esc_html__('Site Title', 'ht-mega-for-elementor' ). '</%1$s>', esc_attr( $title_tag ) );
        }else{
