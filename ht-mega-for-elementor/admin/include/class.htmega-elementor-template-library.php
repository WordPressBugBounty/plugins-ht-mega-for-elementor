...
class Elementor_Library_Manage{
        ...
        $ajax->register_ajax_action( 'get_htmega_template_data', function( $data ) {
            ...
            if ( ! empty( $data['editor_post_id'] ) ) {
                ...
                if ( ! get_post( $editor_post_id ) ) {
                    throw new \Exception( esc_html__( 'Post not found', 'ht-mega-for-elementor' ) );
                }
            ...
            if ( empty( $data['template_id'] ) ) {
                throw new \Exception( esc_html__( 'Template id missing', 'ht-mega-for-elementor' ) );
            }
    ...
    public function elem_template_scripts() {
        ...
        wp_localize_script( 'htmega-templates-library', 'HTMEGAETMP',
            [
                'icon' => HTMEGA_ADDONS_PL_URL .'admin/assets/images/menu-icon.svg',
            ]
        );
