...
== ✅ Floating Effects: ==
The Elementor Floating Effects Module is a dynamic component integrated into our plugin, designed to add captivating and visually appealing animations to your website elements. With this module, you can effortlessly create a wide range of eye-catching effects, including smooth transitions, rotations, scaling, and opacity changes. Whether you want to enhance user engagement, highlight specific content, or simply make your website more interactive, the Floating Effects Module offers a user-friendly and versatile solution to elevate your web design and captivate your audience.
...
* Reading Progress Bar Module's Advanced Features
* Scroll To Top Module's Advanced Features
* Floating Effects Module's Advanced Features
* Custom CSS Module
...
== PRO FEATURES OF HT MEGA: ==

== ✅ Particles: ==

The Elementor Particles module is a powerful tool that empowers users to enhance their websites with dynamic and engaging backgrounds. By utilizing small, animated particles that gracefully move and interact with the cursor, the Particles module adds a touch of interactivity and visual appeal to any web page. Whether you're building a personal blog, a portfolio, or an e-commerce website, this feature enables you to create captivating and immersive user experiences for your visitors. [Check the demo](https://wphtmega.com/widget/elementor-particles-module/) for more details.

== ✅ Cross Domain Copy Paste: ==

Unlock the power of seamless content transfer with the cross domain copy paste module. With this innovative feature, you can effortlessly copy and paste website sections between different domains, streamlining your web development process and saving valuable time. Moreover, you can copy any widget section live from HT Mega demo website and paste it to your own website to make use of it.

== ✅ Parallax: ==

The HT Mega Elementor Parallax module brings captivating scrolling effects to your website's section background images. Additionally, it offers the convenience of adding multiple items with impressive 3D mouseover effects. Elevate your website's visual appeal and user experience effortlessly with this powerful and user-friendly feature. [Check the demo](https://wphtmega.com/widget/elementor-parallax-module/) for more details.

== ✅ Conditional Display: ==

With the Conditional Display module in Elementor, you gain the power to show or hide specific content elements on your website based on a variety of customizable conditions. This versatile feature allows you to create personalized and targeted experiences for your website visitors, as you can set different conditions based on which the web content will be displayed such as viewers' timezone, display, user role and so on.  [Check the demo](https://wphtmega.com/modules/conditional-display-module/) for more details.

== ✅ Advanced Sticky: ==

The Advanced Sticky Module is a powerful tool in Elementor that allows you to easily add sticky elements to your web pages. Whether it's a header, menu, call-to-action button, or any other element you want to stay fixed while users scroll, this module provides a seamless solution. [Check the demo](https://wphtmega.com/modules/advanced-sticky-module/) for more details.

== ✅ Custom CSS: ==

With HT Mega Plugin, you can leverage the "Custom CSS" module to add your own CSS code directly to sections, columns, or widgets. This grants you greater control over visual elements, allowing for a uniquely customized website design. 
...
= Version 2.7.4 - Date: 2024-11-26 =
* Fixed: Button Text Size and Alignment issue in Lightbox Widget.
* Fixed: Toggle Content Cache Issue in Toggle Widget.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of WordPress.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.7.3 - Date: 2024-11-18 =
* Added: Button Text Typography options in Video Player Widget.
* Fixed: SVG icon size issue in Lightbox Widget.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of WordPress.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.7.2 - Date: 2024-11-06 =
* Added: Library Info Transient Expiry Time.
* Fixed: SVG Icon color issue in Social Share Widget.
* Fixed: Old price display issue in Pricing Table Widget.
* Fixed: Background color issue in Service Widget.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of WordPress.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.7.1 - Date: 2024-10-29 =
* Fixed: Function redeclared PHP issue.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.
...
* Fixed: Image missing issue in Admin dashboard.
* Fixed: Sanitizing and Escaping issues.
* Fixed: A few minor issues.

= Version 2.5.7 - Date: 2024-07-01 =
* Updated: WordPress Discourage functions.
* Fixed: Sanitizing and Escaping issues.
* Fixed: A few minor issues.
...
= Version 2.5.2 - Date: 2024-04-29 =
* Added: Individual cell and column heading content align option in Data Table Widget
* Added: Individual cell content color option in Data Table Widget
* Reduced: Plugin file size.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.5.1 - Date: 2024-04-21 =
* Fixed: Elementor Maintenance Mode conflict issue.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.5.0 - Date: 2024-04-16 =
* Fixed: Elementor Maintenance Mode conflict issue.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.4.9 - Date: 2024-04-03 =
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.

= Version 2.4.8 - Date: 2024-03-19 =
* Fixed: PHP Warning issue in Lightbox and Instagram Widgets.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.
* Tested: Compatibility with the latest version of WordPress.

= Version 2.4.7 - Date: 2024-03-11 =
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor.
...
= Version 2.4.0 - Date: 2023-12-13 =
* Added: Post Comment's Title, Description, and Label style options in the Post Comments Widget.
* Added: Placeholder Image in editor mode for the Post Featured Image Widget.
* Added: Demo content in editor mode for the Post Content Widget.
* Fixed: Styles customization issue in the Post Comments Widget.
* Fixed: A few minor issues.
* Tested: Compatibility with the latest version of Elementor

= Version 2.3.9 - Date: 2023-12-04 =
* Fixed: Counter count rescrolling issue in Counter Widget.
* Fixed: Escaping issue in User Register Widget.
* Fixed: A few minor issues.

= Version 2.3.8 - Date: 2023-11-26 =
* Fixed: Carousel activation issue in Slider Thumbnails Gallery Widget
* Fixed: A few minor issues.

= Version 2.3.7 - Date: 2023-11-22 =
* Added: Excerpt length option in Post Carousel and Post Grid widget
* Fixed: A few minor issues.

= Version 2.3.6 - Date: 2023-11-15 =
* Fixed: Carousel default loading issue under tab content in Tabs Widget.
* Fixed: Counter count issue when rescrolling the page in Counter Widget.
* Fixed: A few minor issues.

= Version: 2.3.5 - Date: 2023-11-08 =
* Added: Content type select option (Content/Excerpt) in Post Slider Widget
* Fixed: A few minor issues
...
= Version: 2.3.1 - Date: 2023-10-03 =
* Fixed: Multiple Select field height issue in Contact Form 7 Widget
* Fixed: A few minor issues

= Version: 2.3.0 - Date: 2023-09-26 =
* Added: Floating Effects Module
* Fixed: A few minor issues

= Version: 2.2.8 - Date: 2023-09-20 =
* Added: Scroll image open in Lightbox option in Scroll Image Widget
* Added: Mask Image option in Scroll Image Widget
* Added: Six default mask image shape in Scroll Image Widget
* Added: Badge position control in Scroll Image Widget
