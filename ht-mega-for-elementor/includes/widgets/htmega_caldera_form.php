...
class HTMega_Elementor_Widget_Caldera_Form extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Caldera Form', 'ht-mega-for-elementor' );
    }
    ...
    protected function messing_parent_plg_notice() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Caldera Form', 'ht-mega-for-elementor' ),
            ]
        );
            $this->add_control(
                ...
                [
                    ...
                    'raw' => esc_html__( 'It appears that Caldera Form is not currently installed on your site. Please install or activate Caldera Form, and remember to refresh the page after installation or activation.', 'ht-mega-for-elementor' ),
    ...
    protected function caldera_regster_fields() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'caldera_form_list',
                [
                    'label'   => __( 'Select Form', 'ht-mega-for-elementor' ),
        ...
        $this->add_responsive_control(
            ...
            $this->add_responsive_control(
                'labels_space',
                [
                    'label'   => __( 'Space(px)', 'ht-mega-for-elementor' ),
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'input_space',
                        [
                            'label'   => __( 'Input Space', 'ht-mega-for-elementor' ),
                            'type'    => Controls_Manager::SLIDER,
                            'default' => [
                                'size' => 15,
                            ],
    ...
    protected function render( $instance = [] ) {
        ...
        if ( ! is_plugin_active('caldera-forms/caldera-core.php') ) {
            htmega_plugin_missing_alert( __('Caldera Form', 'ht-mega-for-elementor') );
            return;
        }
        ...
        if ( !$settings['caldera_form_list'] ) {
            echo '<div class="htmega-notices"><p>'.esc_html__('Please select a Contact Form From Setting!', 'ht-mega-for-elementor').'</p></div>';
        }else{
