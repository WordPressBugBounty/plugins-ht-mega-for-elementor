...
class HTMega_Elementor_Widget_Instagram extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Instagram', 'ht-mega-for-elementor' );
    }
    ...
    public function get_help_url() {
        return 'https://wphtmega.com/docs/social-widgets/instagram-widget/';
    }
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'instagram_content',
            [
                'label' => __( 'Instagram', 'ht-mega-for-elementor' ),
            ]
        );
            ...
            //     'userid',
            //     [
            //         'label'         => __( 'Instagram user ID', 'ht-mega-for-elementor' ),
            //         'type'          => Controls_Manager::TEXT,
            //         'placeholder'   => __( '6666969077', 'ht-mega-for-elementor' ),
            //         'label_block'   =>true,
            //         'description'   => htmega_kses_desc( '(<a href="'.esc_url('https://codeofaninja.com/tools/find-instagram-user-id').'" target="_blank">Lookup your User ID</a>)', 'ht-mega-for-elementor' ),
            //     ]
            // );
            ...
            $this->add_control(
                'access_token',
                [
                    'label'         => __( 'Instagram Access Token', 'ht-mega-for-elementor' ),
                    'type'          => Controls_Manager::TEXT,
                    'label_block'   =>true,
                    'description'   => htmega_kses_desc( '(<a href="'.esc_url('https://developers.facebook.com/docs/instagram-basic-display-api/getting-started').'" target="_blank">Lookup your Access Token</a>)', 'ht-mega-for-elementor' ),
                ]
            );
            ...
            $this->add_control(
                'image_link_newtab',
                [
                    'label'         => __( 'Image link in new tab', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'delete_cache',
                [
                    'label'         => __( 'Delete existing caching data', 'ht-mega-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'separator'     => 'before',
                ]
            );
            ...
            $this->add_control(
                'cash_time_duration',
                [
                    'label' => __('Cache Time Duration', 'ht-mega-for-elementor'),
                    'type' => Controls_Manager::SELECT,
                    'options' => [
                        'minute'    => __('Minute', 'ht-mega-for-elementor'),
                        'hour'      => __('Hour', 'ht-mega-for-elementor'),
                        'day'       => __('Day', 'ht-mega-for-elementor'),
                        'week'      => __('Week', 'ht-mega-for-elementor'),
                        'month'     => __('Month', 'ht-mega-for-elementor'),
                        'year'      => __('Year', 'ht-mega-for-elementor'),
                    ],
                    'default' => 'day',
                    'condition'=>[
                        'delete_cache!'=>'yes',
            ...
            $this->add_control(
                'limit',
                [
                    'label' => __( 'Item Limit', 'ht-mega-for-elementor' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::SELECT,
                    'description'   => htmega_kses_desc( 'If the slider is off, Then it will work.', 'ht-mega-for-elementor' ),
                    ...
                    'options' => [
                        ...
                        '5'   => __( '5', 'ht-mega-for-elementor' ),
                        '6'   => __( '6', 'ht-mega-for-elementor' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'show_caption',
                [
                    'label'         => __( 'Show Caption', 'ht-mega-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
            ...
            $this->add_control(
                'show_light_box',
                [
                    'label'         => __( 'Show Light Box', 'ht-mega-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'label_on'      => __( 'Show', 'ht-mega-for-elementor' ),
                    'label_off'     => __( 'Hide', 'ht-mega-for-elementor' ),
                    'return_value'  => 'yes',
            ...
            $this->add_control(
                'zoomicon_type',
                [
                    'label' => esc_html__('Zoom Icon Type','ht-mega-for-elementor'),
            ...
            $this->add_control(
                'show_flow_button',
                [
                    'label'         => __( 'Show Follow Button', 'ht-mega-for-elementor' ),
                    'type'          => Controls_Manager::SWITCHER,
                    'label_on'      => __( 'Show', 'ht-mega-for-elementor' ),
                    'label_off'     => __( 'Hide', 'ht-mega-for-elementor' ),
                    'return_value'  => 'yes',
            ...
            $this->add_control(
                'flow_button_txt',
                [
                    'label' => __( 'Follow button Aditional text', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Follow @', 'ht-mega-for-elementor' ),
                    'condition'=>[
            ...
            $this->add_control(
                'flow_button_icon',
                [
                    'label' =>__('Flow Button Icon','ht-mega-for-elementor'),
                    'type'=>Controls_Manager::ICONS,
                    'default' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'more_options',
                [
                    'label' => esc_html__( 'Item Overlay', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Overlay Padding', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Caption', 'ht-mega-for-elementor' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Follow Button', 'ht-mega-for-elementor' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'=>[
                    'show_flow_button'=>'yes',
                ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => __( 'Icon Width', 'ht-mega-for-elementor' ),
                    'type'    => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'   => __( 'Icon Height', 'ht-mega-for-elementor' ),
                    'type'    => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
    ...
    protected function render( $instance = [] ) {
        ...
        if( empty( $access_token ) ){
            echo '<p>'.esc_html__('Please enter your access token.','ht-mega-for-elementor').'</p>';
            return;
        }
        ...
        if ( false === ( $items = get_transient( $transient_var ) ) ) {
            ...
            if ( ! is_wp_error( $instagram_data ) ) {
                ...
                if ( isset( $instagram_data['error']['message'] ) ) {
                    echo '<p>'.esc_html__('Incorrect access token specified.','ht-mega-for-elementor').'</p>';
                }
