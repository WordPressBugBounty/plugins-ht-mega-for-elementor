...
class HTMega_Elementor_Widget_Instragram_Feed extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Instagram Feed', 'ht-mega-for-elementor' );
    }
    ...
    protected function messing_parent_plg_notice() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Instragram Feed', 'ht-mega-for-elementor' ),
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'raw' => esc_html__( 'It appears that Instragram Feed is not currently installed on your site. Please install or activate Instragram Feed, and remember to refresh the page after installation or activation.', 'ht-mega-for-elementor' ),
    ...
    protected function instagram_feed_regster_fields() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Instagram Feed', 'ht-mega-for-elementor' ),
            ]
        );
        $this->add_control(
            'htmega_feed_id',
            [
                'label' => __( 'Select Feed', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'feed_limit',
                [
                    'label' => esc_html__( 'Feed Limit', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'feed_cols',
                [
                    'label' => esc_html__( 'Number of Column', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::NUMBER,
                    'default' => 4,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'full',
                    'options' => [
                        'auto'   => esc_html__( 'Auto', 'ht-mega-for-elementor' ),
                        'full'   => esc_html__( 'Full', 'ht-mega-for-elementor' ),
                        'medium' => esc_html__( 'Medium', 'ht-mega-for-elementor' ),
                        'thumb'  => esc_html__( 'Thumb', 'ht-mega-for-elementor' ),
                    ],
                ]
            );
            ...
            $this->add_control(
                'show_feed_header',
                [
                    'label'     => esc_html__( 'Show Header', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'show_feed_follow',
                [
                    'label'     => esc_html__( 'Show Follow Text', 'ht-mega-for-elementor' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'default'   => 'no',
                    'label_off' => esc_html__( 'no', 'ht-mega-for-elementor' ),
                    'label_on'  => esc_html__( 'yes', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'follow_text',
                [
                    'label'       => esc_html__( 'Follow Text', 'ht-mega-for-elementor' ),
                    'type'        => Controls_Manager::TEXT,
                    'placeholder' => esc_html__( 'Follow on Instagram', 'ht-mega-for-elementor' ),
                    'default'     => esc_html__( 'Follow on Instagram', 'ht-mega-for-elementor' ),
                    'label_block' => true,
                    'condition' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'imagepadding',
                [
                    'label' => esc_html__( 'Image Padding', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'headercolor',
                [
                    'label' => esc_html__( 'Header Color', 'ht-mega-for-elementor' ),
            ...
            $this->add_control(
                'followcolor',
                [
                    'label' => esc_html__( 'Follow Color', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'condition' => [
                        'show_feed_follow' =>'yes',
            ...
            $this->add_control(
                'followtextcolor',
                [
                    'label' => esc_html__( 'Follow Text Color', 'ht-mega-for-elementor' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'condition' => [
                        'show_feed_follow' =>'yes',
    ...
    protected function render( $instance = [] ) {
        if ( ! is_plugin_active('instagram-feed/instagram-feed.php') ) {
            htmega_plugin_missing_alert( __('Instragram Feed', 'ht-mega-for-elementor') );
            return;
        }
