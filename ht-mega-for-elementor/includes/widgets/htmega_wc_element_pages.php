...
class HTMega_Elementor_Widget_WC_Element_Pages extends Widget_Base {
    ...
    public function get_keywords(){
        return ['htmega','cart page','woocommerce','single product page','checkout page','order tracking form','my account'];
    }

    public function get_help_url(){
        return 'https://wphtmega.com/docs/woocommerce-widgets/woocommerce-page-widget/';
    }
